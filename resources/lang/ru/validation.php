...
return [
    ...
    */
    ...
    'custom' => [
        'eur-amount' => [
            'integer' => 'Сумма транзакции должна быть целым числом.',
            'min' => 'Минимальная сумма транзакции 30 EUR.',
            'max' => 'Максимальная сумма транзакции 10000 EUR.',
        ],
    ],
    ...
    */
    ...
    'messages' => [
        'btcField' => [
            'error'      => 'Невозможно проверить \':attribute\' в данный момент. Попробуйте позже.',
            'success'    => 'Ваш BTC адрес успешно обновлен.',
            'duplicated' => 'Ваш новый BTC адрес должен отличаться от текущего.',
        ],
    ],
];