...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | CryptoProcessing API Key
    |--------------------------------------------------------------------------
    |
    | This key is used to make orders and money operations.
    |
    */

    'crypto_key' => env('CRYPTOPROCESSING_API_KEY'),
    ...
    */
    ...
    'providers' => [
        ...
        App\Providers\CryptoProcessingIntegrationProvider::class,
